...
function verify($conn,$account_id)
{
  // code...
  //fetch user details here
  $mysql_qry = "SELECT accounts.Acc_ID,acc_levels.Access_Level FROM accounts INNER JOIN acc_levels ON accounts.AL_ID = acc_levels.AL_ID WHERE Acc_ID = '$account_id'";
